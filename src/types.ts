...
export interface AuthenticateReturn<UserObjectType extends object> {
	user: UserObjectType | undefined
	info: InfoArgument | undefined
}

export interface WebSocket<Request extends object = ExpressRequest> extends ws {
